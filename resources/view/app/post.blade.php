        ...
        <?= html_entity_decode($post->body) ?>
          ...
          <div class="pt-5 mt-5">
            ...
            <div class="comment-form-wrap pt-5">
              ...
              <?php } else { ?>
                <p>
                  برای ثبت نظر باید ابتدا وارد حساب خود شوید

                <div>
                  <a href="<?= route('auth.login.view') ?>" class="btn btn-success"><span class="icon-user m-2 p-4">ورود</span></a>
                  <a href="<?= route('auth.register.view') ?>" class="btn btn-primary"><span class="icon-pencil m-2 p-4">ثبت نام</span></a>
                </div>
              </p>
              <?php } ?>
            </div>
